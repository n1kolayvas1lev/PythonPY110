...
BOOKS_FILE = "books.md"
BOOK_REGEX = r'####\s(?P<position>\d+)\.\s\[(?P<book>.+?)\]\((?P<book_url>.+?)\)\sby\s+(?P<author>.+?)\s+\((?P<recommended>\d+\.\d+%).+?\((?P<cover_url>.+?)\).+?\"(?P<description>.+?)\"'  #  записать ругулярное выражения для поиска книги
